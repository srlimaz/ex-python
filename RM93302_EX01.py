...
if assinatura == "basic":
    ...
    print("Sua assinatura BASIC representa um cobrança de 20 porcento do seu faturamento, e o valor a pagar é de R$" + str(resultado))
elif assinatura == "gold":
    resultado = fat_anual * 0.1
    print("Sua assinatura BASIC representa um cobrança de 10 porcento do seu faturamento, e o valor a pagar é de R$" + str(resultado))
elif assinatura == "platinum":
    resultado = fat_anual * 0.05
    print("Sua assinatura BASIC representa um cobrança de 5 porcento do seu faturamento, e o valor a pagar é de R$" + str(resultado))